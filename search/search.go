...
func getRandomBlockWithVariableSize(minPrivKey, maxPrivKey *big.Int, initialBlockSize int64, intervalTree *IntervalTree) (*big.Int, int64) {
    ...
    for blockSize > 0 {
        ...
        // Reduzir o tamanho do bloco se houver sobreposição
        blockSize /= 10
    }
...
func searchInBlock(wallets *Wallets, block *big.Int, actualBlockSize int64, stopSignal chan struct{}, keysChecked *int64, startTime time.Time) {
