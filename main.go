...
func main() {
	...
	color.Cyan("FORK: BTCGO - Investidor Internacional v0.1")
	color.White("___________________________________________")
	color.Cyan("__________BTCGO - Mod BY: Inex_____________")
	color.White("__________________v1.1_____________________")
...
func promptBlockSize() int64 {
	...
	for {
		fmt.Print("Digite o tamanho do bloco (Recomendado 10M para wallet 66): ")
		input, _ := reader.ReadString('\n')
		input = strings.TrimSpace(input)
